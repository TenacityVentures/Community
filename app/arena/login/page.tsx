            ...
            <div className="bg-white rounded-2xl shadow-lg border border-[#37322f]/5 p-8 sm:p-10">
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 border-2 border-[#E0DEDB] rounded-lg px-4 py-3 text-[#37322f] font-medium hover:border-[#37322f] hover:bg-[#f7f5f3] transition-all duration-300"
                >
              ...
              <form onSubmit={handleMagicLink} className="space-y-4">
                <input
                  ...
                  className="w-full border-2 border-[#E0DEDB] rounded-lg px-4 py-3 focus:outline-none focus:border-[#37322f] text-[#37322f] transition-colors"
                  required
                />
                <button
                  type="submit"
                  disabled={loading || !email}
                  className="w-full bg-[#37322F] text-white rounded-lg px-4 py-3 font-medium hover:bg-[#4a443f] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
