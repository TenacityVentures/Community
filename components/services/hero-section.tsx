  ...
  return (
    ...
    >
      <div className="text-center max-w-4xl px-4">
        {/* H1 — each line slides up through its own overflow-hidden gate */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-normal text-[#37322F] leading-[1.1] mb-6 sm:mb-8">
          <div className="overflow-hidden pb-[0.06em]">
            <motion.span
              ...
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
              transition={{ duration: 0.75, delay: 1.20, ease: [0.22, 1, 0.36, 1] }}
            >
              We build the
            </motion.span>
          </div>
        ...
        <motion.p
          ...
          transition={{ duration: 0.65, delay: 1.68, ease: [0.22, 1, 0.36, 1] }}
        ...
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.55, delay: 1.86, ease: [0.22, 1, 0.36, 1] }}
