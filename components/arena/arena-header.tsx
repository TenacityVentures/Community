            ...
            {loading ? (
              ...
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-[#37322f] text-white flex items-center justify-center text-sm font-medium overflow-hidden">
                      {profile?.avatar_url ? (
                        <img
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-[#E0DEDB] overflow-hidden"
                      >
                        {/* User Info */}
                        <div className="px-4 py-3 border-b border-[#E0DEDB]">
                          <p className="font-medium text-[#37322f] truncate">
                        ...
                        <div className="py-1">
                          ...
                          >
                            <User className="w-4 h-4 text-[#605A57]" />
                            Your Profile
                          </Link>
                          <Link
                            href="/arena/settings"
                            ...
                            className="flex items-center gap-3 px-4 py-2.5 text-sm text-[#37322f] hover:bg-[#f7f5f3] transition-colors"
                          >
                            <Settings className="w-4 h-4 text-[#605A57]" />
                            Settings
                          </Link>
                        </div>

                        {/* Sign Out */}
                        <div className="border-t border-[#E0DEDB] py-1">
                          <button
                            onClick={() => {
                              signOut()
                              setIsDropdownOpen(false)
