      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">Tenacity</div>
          </div>
          ...
          <div className="flex justify-start items-start gap-4">
            ...
            {/* LinkedIn Icon */}
            <div className="w-6 h-6 relative overflow-hidden">
              <Link href={'https://www.linkedin.com/company/tenacityventure'} className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            {/* GitHub Icon */}
            <div className="w-6 h-6 relative overflow-hidden">
              <Link href={'https://www.github.com/tenacityventures'} className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2">
              <Link href={'https://www.getlia.live'} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                LIA
              </Link>
              <Link href={'https://www.storyafrika.live'} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                StoryAfrika
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              ...
              <Link href={'/menifesto'} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                Manifesto
              </Link>
              <Link href={'mailto:community@10na.city'} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">
                Contact: <span className="text-blue-400">community@10na.city</span>
              </Link>
            </div>
          </div>
          ...
          {/* Resources Column */}
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5 font-sans">Services</div>
