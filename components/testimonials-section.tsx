...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "I'm accelerating Tenacity's growth because I believe they have what it takes to build.",
      name: "Joe Abass",
      company: "Founder, Startup Bodyshop",
      image:
        "/people/joeabass.png",
    },
    {
      quote:
        "We are scaling BVX worforce through Tenacity's structured management and systems.",
      name: "Eno Peter",
      company: "Founder, Benevox",
      image:
        "/people/eno-peter.png",
    },
  ]
